...
<!--   {{--================================================================== --}} --> 
     <div class="form-group">
        ...
        {!! Form::text('name',$quick->name,['class'=>'form-control']) !!}
     </div>

     <div class="form-group">
        {!! Form::label('email',trans('admin.email')) !!}
        {!! Form::email('email',$quick->email,['class'=>'form-control']) !!}
     </div>
     ...
     <div class="form-group">
        ...
        {!! Form::file('icon',['class'=>'form-control']) !!}
          ...
          @if(!empty($quick->icon))
       <img src="{{ Storage::url($quick->icon) }}" style="width:50px;height: 50px;" />
      @endif
