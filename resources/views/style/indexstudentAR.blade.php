...
<head>
    ...
    <link rel="stylesheet" href="{{ url('design/style') }}/css/style_ar.css">
               ...
               <div class="container">
                ...
                <button class="navbar-toggler" type="button"data-toggle="collapse" data-target="#navbarSupportedContent"aria-controls=" navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                      <span class="navbar-toggler-icon"> <i class="fa fa-list  fa-2x"></i></span>
                        ...
                        <li class="nav-item ">
                             <a class="nav-link" href="#whyus"> لماذ نحن <span class="sr-only">(current)</span></a>
                        </li>
                         <li class="nav-item">
                             <a class="nav-link" href="#courses">كروسات</a>
                         </li> 
                        <li class="nav-item">
                              <a class="nav-link" href="#Videos">فديو</a>
                      </li>   
                      <li class="nav-item">
                              <a class="nav-link" href="#Teachers">المعلموان</a>
                      </li> 
                       <li class="nav-item"  >
                             <a class="nav-link" href="#Package"> </a>
                      </li>
                      <li class="nav-item">
                              <a class="nav-link" href="#testimonial" target="_self"> اراء العملاء    </a>
                      </li> 
                      <li class="nav-item">
                              <a class="nav-link" href="#statistics">الاحصاءيات</a>
                     </li>  
                     <li class="nav-item">
                              <a class="nav-link"  data-toggle="modal" data-target="#myModal" >تواصل معنا </a>
                     </li>  
                     <li class="nav-item dropdown">
                            ...
                            <a class="dropdown-item" href="#">  طالب</a>
                            <a class="dropdown-item" href="#">  معلم</a>
                     </li> 
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="student" target="_blank">  طالب</a>
                        <a class="dropdown-item" href="teacher">  معلم</a>
                    </li> 
                     <li class="nav-item dropdown">
                     ...
                     <h1 class="text-slader"> 
                       <div class="text-colip">   
                            @foreach($Slidertext as $slidtext)  
                             <span class="span-clip-title wow animated" style="visibility: visible;">{{$slidtext->head_ar}}</span> 
                              <section class="wow bounceIn" style="visibility: visible; animation-name: bounceIn;">
                                  <span class="span-clip-title  ">{{$slidtext->title_ar}}  </span>
                                  ...
                                  <span class="cd-words-wrapper  wow bounceIn" style="width: 52.1313px; visibility: visible; animation-name: bounceIn; overflow: hidden;">
                                    <b class="bold is-visible">{{$slidtext->text1_ar}}  </b>
                                    <b class="bold is-hidden">{{$slidtext->text2_ar}}   </b>
                                    <b class="is-hidden">{{$slidtext->text3_ar}}  </b>
                                   @endforeach  
                              </span>
                         </span>
                   </section> <!-- cd-intro -->
         ...
         <div class="container  content_form_effecte">
            <div class="card card-form_effecte " ></div>
              <div class="card card_form_effecte alt">
                <div class="toggle" style="width: 100px;height: 100px;">  تسجيل سريع </div>
                 <h1 class="title">انشاء حساب 
                  <div class="close"></div>
                   </h1>
       ...
       <div class="modal-content">
                <!-- Modal Header -->
                              ...
                              <div class="col-lg-6 left-3-input">
                                ...
                                <input type="email" class="form-control" name="email"   placeholder="الاميل ">
                                <input type="text" class="form-control"  name="subject" placeholder="الموضوع">
                             </div>
                             <div class="col-lg-6">
                                 <input type="text" class="form-control"     name="phone"    placeholder="الموبيل">
                                 <textarea class="form-control"              name="message"   placeholder="  الرساله "></textarea> 
                            </div>
                           </div><!-- ./row -->
            ...
            <section class=" title back-fff" id="one">
                <div class="container ">
                    <div class="section-header text-center">
                           ...
                           لماذ نحن  <i class="fa fa-question-circle-o"></i>
                           </h2>
                          <div class="line">
                        </div><!--/.heazder-->
                  ...
                  <div  class="col-sm-6 col-lg-3  col-lg-padding">
                    <div class="  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s" style="visibility:    visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: fadeInUp;">
                        <div class=" text-center">
                             ...
                             <h4 class="h4-whyus">{{$why->text_ar}} <span class="span-whyus">  {{$why->color_diffe_ar}} </span> </h4>
                        </div><!-- contant -->
                    </div><!-- col-sm-6 -->
                  </div><!-- col-sm-6 -->
           @endforeach  
              ...
              <aside class="asid-title-price" style="font-size: 22px">
                 <div class="prograss_bar">
                     <button class="pull-left btn-danger price-minus" style="font-size: 22px"><i class="fa fa-minus"></i></button>
                       <span class="text-center price_value text-mins" >30 دقيقه</span>
                      ...
                      <div class="price-package">
                        <div class="package-name">
                         ...
                         <span >${{$half->number}}</span>
                          ...
                          <div class="term">
                            <sup></sup>
                            <span style="text-decoration: line-through;">{{$half->dateshow_ar}}</span>
                          </div>
                        <div class="package-features">
                          <div class="package-arrow back-too"></div>
                          <ul>
                          <?php  $str =$half->content_ar ?>
                         <?php
                          $arr = explode("," , $str);
                          for ($i = 0; $i < count($arr); $i ++) {
                          echo   '<li><em>'. $arr[$i] .'</em></li>';
                         }?> 
                         <li style="    padding: 0px 19px;"><em>{{$half->descount3_ar}}
                          <span >(<span class="color_ffcc00">{{$half->percentage3}}</span>)</span></em>
                         </li>
                          <!--  ------------->
                         <li style="    padding: 0px 19px;"><em>{{$half->descount6_ar}}
                          <span >(<span class="color_ffcc00">{{$half->percentage6}}</span>)</span></em>
                         </li>
                          <!--  ------------->
                         <li style="    padding: 0px 19px;"><em>{{$half->descount12_ar}}
                  ...
                  <div class="price-package">
                                      <div class="package-name">
                                       <h2>{{$ho->head_ar}}</h2>
                                        ...
                                        <div class="term">
                                          <sup></sup>
                                          <span>{{$ho->dateshow_ar}}</span>
                                        </div>
                                      <div class="package-features">
                                        <div class="package-arrow"></div>
                                        <ul>
                                         <?php  $str =$ho->content_ar ?>
                                         <?php
                                          $arr = explode("," , $str);
                                          for ($i = 0; $i < count($arr); $i ++) {
                                          echo   '<li><em>'. $arr[$i] .'</em></li>';
                                         }?> 
                                         <li class="padding_19px"><em>{{$ho->descount3_ar}}
                                          <span >(<span class="color_ffcc00">{{$ho->percentage3}}</span>)</span></em>
                                         </li>
                                          <!--  ------------->
                                         <li class="padding_19px"><em>{{$ho->descount6_ar}}
                                          <span >(<span class="color_ffcc00">{{$ho->percentage6}}</span>)</span></em>
                                         </li>
                                          <!--  ------------->
                                         <li class="padding_19px"><em>{{$ho->descount12_ar}}
              ...
              <div class=" pic-inf  ">
               <img src="storage/{{$test->img}}">
                      ...
                      <div class=" team-content-inf  ">
                       <h5 class="title-inf">{{$test->name_ar}}</h5>
                       <p class="post-inf">{{$test->job_ar}}</p>
                       <p class=" ">
                                ...
                                <div class="card card-beststudan">  
                                   <div class ="background-f4">  
                                    <img class="card-img-top" src="storage/{{$best->img}}"    alt="Card image cap">
                                      ...
                                      <div class="card-body">
                                         <h4 class="card-title">{{$best->name_ar}} </h4>
                                          <article class="article-subtitle" > 
                                          <i class="icon-calendar"></i>  
                                          <span class="card-subtitle">{{$best->date_ar}} </span>
                                          <i class="icon-chat"></i> 
                                            <span class="card-subtitle">{{$best->Lecture_ar}} </span>
                                        </article><!--  article-subtitle --> 
                                        <p class="card-text section-desc text-left myBox">{{$best->text_ar}} </p>
                                  ...
                                  <a href="#" class="a-img-Ather ">
                                   <img  src="storage/{{$best->img_Teacher}}" alt=""> 
                                    ...
                                    <span >
                                     <span class="name-Author" >{{$best->name_Teacher_ar}}</span>
                                    <author>({{$best->job_ar}})</author>
                                    </span>
                                  </span>
                                </a>
                               </div>
         ...
         <h3 class="footer-title"> من نحن  </h3>
          <p align="justify" class="p-linhight">
                 ...
                 <!-- Ends: .footer-widget -->
                    ...
                    <div class="col-md-6 col-lg-3 col-sm-12">
                            <h3 class="footer-title"> لينكات هامه</h3>
                            <ul class="list-unstyled contact-info text-left ul-import-info" >
                            @foreach($footer as $foot)
                            <?php   $str =$foot->import_info_ar ?>
                            <?php
                            $arr = explode("," , $str);
                            for ($i = 0; $i < count($arr); $i ++) {
...
<script src="{{ url('design/style') }}/js/vendrs/Animated-Headilines2.js"></script>
 <script src="{{ url('design/style') }}/js/script_ar.js"></script>
</html>
