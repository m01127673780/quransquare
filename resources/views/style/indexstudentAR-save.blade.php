  ...
  @foreach($hour as $ho)
   <div class="col-sm-6 col-lg-3">
    ...
    <?php  $str =$ho->content_ar ?>
               ...
               <li style="    padding: 0px 19px;"><em>{{$ho->descount3_ar}}
                <span >(<span style="color:#ffcc00">{{$ho->percentage3}}</span>)</span></em>
               </li>
                <!--  ------------->
               <li style="    padding: 0px 19px;"><em>{{$ho->descount6_ar}}
                <span >(<span style="color:#ffcc00">{{$ho->percentage6}}</span>)</span></em>
               </li>
                <!--  ------------->
               <li style="    padding: 0px 19px;"><em>{{$ho->descount12_ar}}
